...
Sub ImportLSVData()
    ...
    For fi = 1 To fileCount
        ...
        Do While Not EOF(fileNum)
            ...
            ' Flexible header match: covers both
            '   "Potential/V, Current/A"  (comma format)
            '   "Potential/V<tab>Current/A" (tab format)
